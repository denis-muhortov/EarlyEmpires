...
export default {
    ...
    methods: {
        ...
        editBalanceWithdraw(amount) {
            this.bridgeAmount = this.game.findBalance(this.game.player.balances, 'EET') * (amount / 100);
        },
    ...
    <div class="panel_block_main">
        <div class="block_change">
            <div class="container_change">
                <div class="balance">
                    Wallet balance: {{ game.walletBalanceEET.toFixed(2) }}
                </div>
